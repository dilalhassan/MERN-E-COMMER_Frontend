      ...
      <div className="nav sticky-top">
        ...
        {location.pathname == "/" && (
          <div className="sub_bar">
            ...
            <div className="items" onClick={() => filterbyCategory("camaras")}>
              camaras
            </div>
            <div
              className="items"
            ...
            <div className="items" onClick={() => filterbyPrice(25000)}>
              25000
            </div>
            <div className="items" onClick={() => filterbyPrice(56999)}>
              56999
            </div>
            <div className="items" onClick={() => filterbyPrice(91000)}>
              98000
            </div>
